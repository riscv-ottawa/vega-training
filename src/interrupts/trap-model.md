...
This section pairs with the [`apps/vegaconsole-irq/`](https://github.com/riscv-ottawa/vega-quickstart/tree/main/apps/vegaconsole-irq) example app in the accompanying [`vega-quickstart`](https://github.com/riscv-ottawa/vega-quickstart) repository. The trap path we build here lives in [`trap_entry.S`](https://github.com/riscv-ottawa/vega-quickstart/blob/main/apps/vegaconsole-irq/trap_entry.S) (the vector table and assembly stub) and [`trap.c`](https://github.com/riscv-ottawa/vega-quickstart/blob/main/apps/vegaconsole-irq/trap.c) (the C dispatcher), and the `crash` command we use to trigger a trap is in [`main.c`](https://github.com/riscv-ottawa/vega-quickstart/blob/main/apps/vegaconsole-irq/main.c). Feel free to open them up and refer to them as you read along.
