...
- A new `react` reaction-time command will measure how fast you can press a button after an LED lights up. This will be a nice visual proof that the foreground and background are now decoupled.
...
4. **[Challenge](./challenge.md)** asks you to add the `react` reaction-time command to VegaConsole.
